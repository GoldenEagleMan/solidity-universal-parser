...
public interface SolidityVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#spdxLicenseIdentifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpdxLicenseIdentifier(SolidityParser.SpdxLicenseIdentifierContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#overrideParameters}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOverrideParameters(SolidityParser.OverrideParametersContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#objectList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectList(SolidityParser.ObjectListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#ifRight}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfRight(SolidityParser.IfRightContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#ifWrong}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfWrong(SolidityParser.IfWrongContext ctx);
	/**
